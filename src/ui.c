...
/* The panel font lived here as a second copy of the same 8x8 table. It went when the panels
   started drawing through the shared atlas in render.c: two copies of a font is how a spacing
   fix gets applied to one of them and not the other. */
