...
--conn-test --file-test --parts-file-test --undo-test --session-test --ee-test --dpdt-test --residual-test --pin-test --text-test --bias-test --netlist-test --line-test --std-test --burn-test --knob-test --geom-test --param-test --sweep-check
--tesla-test"
