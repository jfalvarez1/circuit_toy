...
**Latest Release: [v3.33.0](https://github.com/jfalvarez1/circuit_toy/releases/tag/v3.33.0)** (auto-updating from v3.4.0 on) · [all releases](https://github.com/jfalvarez1/circuit_toy/releases)
...
build/tools/template_smoke.exe --wire-test       # a wire drawn through a node it is not joined to, and wires ending nowhere
